...
CREATE TABLE "email_challenge" (
    ...
    CONSTRAINT "email_challenge_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE INDEX "email_challenge_normalized_email_idx" ON "email_challenge"("normalized_email");

-- CreateIndex
CREATE INDEX "email_challenge_university_id_idx" ON "email_challenge"("university_id");
...
-- AddForeignKey
ALTER TABLE "email_challenge" ADD CONSTRAINT "email_challenge_university_id_fkey" FOREIGN KEY ("university_id") REFERENCES "university"("id") ON DELETE CASCADE ON UPDATE CASCADE;

/**
 * Passwordless university-email demo (OTP challenge, roster gate, public
 * username). Kept as a secondary panel: email + password is now the primary
 * sign-in route, but this flow still exercises the university lane.
 */
